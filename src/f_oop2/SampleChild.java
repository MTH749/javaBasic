...
public class SampleChild extends SampleParent {
	...
	public static void main(String[] args) {
		...
		//부모타입이 갖고 있는 멤버만 사용할 수 있다.
		System.out.println("sp var :" + sp.var);
		System.out.println("sc var :" + sc.var);
		System.out.println("sp.method() :" + sp.method(5,10)); //오버라이딩 된 메서드만 사용 가능
	...
	void test(double var){
		...
		System.out.println( this. var); //인스턴수 변수
		System.out.println(super.var);//부모클래스의 인스턴스 변수
		//super : 부모클래스의 멤버와 자식클래스의 멤버가 이름이 중복 될때 둘을 구분하기 위해 사용한다.
