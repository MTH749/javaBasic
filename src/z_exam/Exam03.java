...
System.out.println(y >= 5 || x < 0 && x > 2);(true || false) =  true
...
int numOfBucket = ( numOfApples % sizeOfBucket > 0 ? numOfApples / sizeOfBucket + 1 : + 2;) // 모든 사과를 담는데 필요한 바구니의 수
...
public static void main(String[] args) {
char ch = 'z';
boolean b = (  'a' <= ch && ch <= 'z' || 'A' <= ch && ch <='Z' ||  0 <= ch && ch <= 128  );
